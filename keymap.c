...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_TMUX] = LAYOUT_ergodox(
      ...
      _______, _______,     _______,     M(M_TMUX_OPEN_URL), TERM_PASTE,       M(M_TMUX_BREAK_PANE), _______,
      _______, _______,     _______,     _______,            _______,
                     _______,        _______,
                                     _______,
   ...
   * |        |      |      |      |      |      |      |           |      |   6  |   7  |   8  |   9  |      |        |
   * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
   * |        | MOVE |ROTATE| PUSH | RECT |TAPE M|------|           |------|   1  |   2  |   3  |   4  |   5  |        |
   * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
   * |        |      |      |ORBIT | PAN  |      |      | // camera |      |      |   /  |   ,  |   '  |   "  |        |
   * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
   *   |      |      |      |      |      |                                       |   0  |      |      |      |      |
  ...
  [_SKETCHUP] = LAYOUT_ergodox(
      ...
      _______, _______, _______,   _______, _______, _______, _______,
      _______, _______, _______,   _______, _______, _______, _______,
      _______, SU_MOVE, SU_ROTATE, SU_PUSH,  SU_RECT, SU_TAPE_M,
      _______, SU_UNDO, SU_REDO,   SU_ORBIT, SU_PAN, _______, _______,
      _______, _______, _______,   _______, _______,
               _______, _______,
                        _______,
      _______, _______, _______,
      ...
      _______, KC_6,    KC_7,    KC_8,    KC_9,    _______,    _______,
               KC_1,    SU_2,    KC_3,    KC_4,    KC_5,    _______,
      _______, _______, KC_SLSH, KC_COMM, KC_QUOT, KC_DQUO, _______,
